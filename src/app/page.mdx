...
## Remote Database {{ date: '2025-11-10T00:00Z' }}
...
- Multitenancy: Domains are segregated by sharding, and tokens can be assigned to specific domains, preventing permission leakage.
